...
colores =["roja","blanca","verde"]
naciones =["aleman","ingles", "danes","britanico"]
mascotas = ["pez", "perro", "gato", "pajaro"]
bebidas =["te", "cafe", "cerveza", "agua"]
cigarros=["Pall Mall", "Brends", "Bluemasters", "prince"]
                                                                    ...
                                                                    for mas4 in mascotas4:                                                                            
                                                                        for beb4 in bebidas4:                                                                            
                                                                            for cig4 in cigarros4:                                                                                
                                                                                ...
                                                                                prueba = prueba + 1
                                                                                casas=[]
                                                                                casas.append(Casa("amarilla", "noruego", mas1, beb1, "Dunhill"))
                                                                                casas.append(Casa("azul", nac2, "caballo", beb2, cig2))
